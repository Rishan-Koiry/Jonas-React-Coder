...
import { depositWithCurrency, withdraw, requestLoan, payLoan } from './features/accountSlice';
...
function AccountOperations() {
  ...
  const { balance, loan, loanPurpose: currentLoanPurpose, isLoading } = useSelector(
    (state) => state.account
  );

  function handleDeposit() {
    if (!depositAmount) return;
    dispatch(depositWithCurrency(Number(depositAmount), currency));
    setDepositAmount('');
    setCurrency('USD');
  }

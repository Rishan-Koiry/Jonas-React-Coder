    ...
    <div className="min-h-screen bg-gray-50 py-16 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white p-8 md:p-12 rounded-2xl shadow-sm space-y-6">
          ...
          <p className="text-lg text-gray-600 leading-relaxed">
            Our master chefs have perfected the art of pizza making, ensuring
            every bite is a delightful experience. From classic Margherita to
            innovative specialty pizzas, we have something for everyone.
          </p>
